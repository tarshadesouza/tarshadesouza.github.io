  ...
  books: [
    {
      ...
      subject: 'Engineering',
      note: 'Craft over ceremony — naming, duplication, and the small habits that decide whether a codebase stays workable.', shelf: 'non-fiction' as const,
    },
    { title: 'Atomic Habits', author: 'James Clear', subject: 'Behaviour', note: 'Behaviour change as systems design: make the thing you want easy, and the thing you don’t awkward.', shelf: 'non-fiction' as const },
    { title: 'Flow', author: 'Mihaly Csikszentmihalyi', subject: 'Psychology', note: 'The psychology of absorbed attention, and the conditions that reliably produce it.', shelf: 'non-fiction' as const },
    { title: 'Contagious', author: 'Jonah Berger', subject: 'Behaviour', note: 'Why some ideas travel and others don’t, taken apart into six mechanisms.', shelf: 'non-fiction' as const },
    { title: 'Lean In', author: 'Sheryl Sandberg', subject: 'Work', note: 'Ambition, negotiation, and the structural parts of workplaces that hold women back.', shelf: 'non-fiction' as const },
    {
      title: 'Brief Answers to the Big Questions',
      author: 'Stephen Hawking',
      subject: 'Science',
      note: 'Hawking’s last book — black holes, time, AI, and whether we ought to leave Earth.', shelf: 'non-fiction' as const,
    },
    {
      title: 'Different Kinds of Minds',
      author: 'Temple Grandin',
      subject: 'Science',
      note: 'Grandin on visual, verbal and pattern thinkers, and what a team loses by hiring only one kind.', shelf: 'non-fiction' as const,
    },
    { title: 'Outliers', author: 'Malcolm Gladwell', subject: 'Behaviour', note: 'Success as circumstance: timing, culture and accumulated advantage rather than talent alone.', shelf: 'non-fiction' as const },
    {
      title: 'Algorithms to Live By',
      author: 'Brian Christian & Tom Griffiths',
      subject: 'Science',
      note: 'Computer science pointed at ordinary decisions — when to stop looking, how to sort, how to schedule.', shelf: 'non-fiction' as const,
    },
    // Fiction, memoir and essays.
    {
      ...
      subject: 'Fiction',
      note: 'A childhood on Corfu, told by a naturalist with an equally sharp eye for animals and relatives.', shelf: 'fiction' as const,
    },
    {
      ...
      subject: 'Fiction',
      note: 'A Yorkshire vet’s rounds in the 1930s. Warm, and very funny.', shelf: 'fiction' as const,
    },
    { title: 'A Walk in the Woods', author: 'Bill Bryson', subject: 'Travel', note: 'Bryson and a spectacularly unsuited friend attempt the Appalachian Trail.', shelf: 'non-fiction' as const },
    { title: 'Calypso', author: 'David Sedaris', subject: 'Essays', note: 'Sedaris on family, ageing and a beach house — funnier and considerably darker than that sounds.', shelf: 'non-fiction' as const },
    { title: 'Heartburn', author: 'Nora Ephron', subject: 'Fiction', note: 'A novel about a marriage ending, with recipes.', shelf: 'fiction' as const },
    { title: 'Auntie Mame', author: 'Patrick Dennis', subject: 'Fiction', note: 'A boy raised by his gloriously unsuitable aunt in Jazz Age New York.', shelf: 'fiction' as const },
    { title: '1984', author: 'George Orwell', subject: 'Classic', note: 'Surveillance, language, and the rewriting of the past.', shelf: 'fiction' as const },
    { title: 'The Picture of Dorian Gray', author: 'Oscar Wilde', subject: 'Classic', note: 'Beauty, corruption, and a portrait that takes the damage.', shelf: 'fiction' as const },
  ],
};
